...
function getFromCat(i){
    selectedCategory = document.querySelector("#t" + i).textContent.toLowerCase();
...
function searchCategory(){
	let request = new XMLHttpRequest();
	  request.open("GET", `https://api.edamam.com/search?q=${selectedCategory}&ingr=5&app_id=${API_ID}&app_key=${API_KEY}`, true)
...
let request = new XMLHttpRequest();
  request.open("GET", `https://api.edamam.com/api/nutrition-details?app_id=${API_ID_N}&app_key=${API_KEY_N}&title=${recipeName}&ingr=${ingrList}`, true)
